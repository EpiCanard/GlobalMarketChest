...
public class PlayerUtils {
  ...
  public String getPrefix() {
    if (ConfigUtils.getBoolean("Logs.HidePrefix", false)) {
  ...
  public ItemStack getPlayerHead(OfflinePlayer player) {
    final Material headMaterial = Material.getMaterial((GlobalMarketChest.plugin.getMinecraftVersion().isEqualsTo(1, 12)) ? "SKULL_ITEM" : "PLAYER_HEAD");
